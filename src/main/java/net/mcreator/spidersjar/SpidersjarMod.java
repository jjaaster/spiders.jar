package net.mcreator.spidersjar;
...
import net.mcreator.spidersjar.init.SpidersjarModTabs;
import net.mcreator.spidersjar.init.SpidersjarModItems;
import net.mcreator.spidersjar.init.SpidersjarModEntities;
...
@Mod("spidersjar")
public class SpidersjarMod {
	public static final Logger LOGGER = LogManager.getLogger(SpidersjarMod.class);
	public static final String MODID = "spidersjar";

	public SpidersjarMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		SpidersjarModItems.REGISTRY.register(modEventBus);
		SpidersjarModEntities.REGISTRY.register(modEventBus);
		SpidersjarModTabs.REGISTRY.register(modEventBus);
